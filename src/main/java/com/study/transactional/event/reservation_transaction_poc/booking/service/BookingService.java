...
public class BookingService {
    ...
    public Long createBooking(Long userId, String productId) {
        ...
        // 2. 예약 정보를 저장
        Reservation reservation = new Reservation(userId, productId, userPhone, BookingStatus.RESERVED);
        ...
        ReservationCreatedEvent event = new ReservationCreatedEvent(savedReservation.getId(),
                savedReservation.getUserPhone(),
                savedReservation.getProductId());
        bookingOutboxService.createOutboxEvent(event);
