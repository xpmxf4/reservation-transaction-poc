...
public class UmsPropagationService {
    ...
    public void sendAlimtalkWithRequired(String phoneNo, TemplateCode templateCode, String key) {
    ...
    public void sendAlimtalkWithRequiresNew(String phoneNo, TemplateCode templateCode, String key) {
    ...
    public void sendAlimtalkWithNested(String phoneNo, TemplateCode templateCode, String key) {
